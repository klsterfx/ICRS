        ...
        <div class="content-wrapper">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
				<f:form action="saveCollege" method="post" modelAttribute="collegeVO"
					id="addSkillForm">
                    <fieldset>
                      
                      <div class="form-group">
                        <label for="cname">Name:</label>
                  		<f:input path="collegeName" name="college" id="" cssClass="form-control"/>
                      </div>
                      
                      <div class="form-group">
                        <label for="cemail">Description</label>
                       	<f:textarea path="description" cssClass="form-control" id=""/>
                      </div>
                      
                      <div class="form-group">
                        <label for="cemail">Address</label>
                       	<f:textarea path="address" cssClass="form-control" id=""/>
                      </div>
                      
                      <f:hidden path="collegeId"/>
